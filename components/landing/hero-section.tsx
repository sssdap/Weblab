      ...
      <div className="mx-auto max-w-7xl px-4 py-24 sm:px-6 sm:py-32 lg:px-8 lg:py-40">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="mb-8 inline-flex items-center rounded-full border border-accent/30 bg-accent/10 px-4 py-1.5 text-sm font-medium backdrop-blur-sm">
            <span className="text-accent">Платформа</span>
            <span className="mx-2 text-border">|</span>
            <span className="text-muted-foreground">
              Обучение веб-разработке для каждого уровня
            </span>
          </div>
          ...
          <h1 className="text-balance text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl">
            ...
            <span className="block text-accent">с нуля до профессионала</span>
          </h1>

          {/* Subtitle */}
          <p className="mx-auto mt-6 max-w-2xl text-pretty text-lg leading-relaxed text-muted-foreground">
            Изучайте HTML, CSS, JavaScript, React и Next.js через интерактивные
            уроки, реальные проекты и обратную связь от экспертов.
            Присоединяйтесь к тысячам студентов, создающих современный веб.
          </p>
